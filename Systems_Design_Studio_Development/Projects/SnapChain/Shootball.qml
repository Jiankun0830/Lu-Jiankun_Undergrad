...
//                  var collidedEntityId = collidedEntity.entityId;
          ...
          if (agentBall.y < 950 && agentBall.y > 50 && agentBall.x > 0 && agentBall.x < 600){
             agentBall.player= 0;
          }
          if (agentBall.y < 950 && agentBall.y > 50 && agentBall.x >1000 && agentBall.x < 1600){
             agentBall.player= 1;
          }
          if (agentBall.y < 900 && agentBall.y > 100 && agentBall.x > 600 && agentBall.x < 1000){
